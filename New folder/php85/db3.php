...
// }
	...
	// nicher ei code dia data input dei database e 
...
echo $connect->Insert("students","name='Habib',mobile='01854138817'")?"Data Inserted":"Insert Fail";
echo "<br>";
echo $connect-> Update("students","name='Kamal'","id=2")?"Data Inserted":"Insert Fail";
echo "<br>";
echo $connect-> Delete("students","id=2")?"Data Inserted":"Insert Fail";



//echo $connect->Insert("students","name='Habib'","mobile='01854138817'")?"Success":"fail";

//print_r($connect->getById("students","*","id=2"));
//echo $connect->getList($students);
